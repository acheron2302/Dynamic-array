 ...
 * @file
 * @author Kishou Yusa
 * @brief Create and manage unbouded array
 */
#ifndef DARRAY_H
#include <stdlib.h>
...
typedef struct {
    ...
    int capacity; ///< Capacity number of open space in the array
    int *data; ///< Storing the element
} Vector;

/// Initialize a dynamic array with VECTOR_INIT_CAPACITY capacity
...
/// @param *vector the pointer to a Vector variable that have been initialized
/// @param index the index to get back from a Vector
